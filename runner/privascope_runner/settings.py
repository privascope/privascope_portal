"""
Django settings for privascope_runner project.
...
SECRET_KEY = os.getenv('SECRET_KEY_RUNNER')
...
ROOT_URLCONF = 'privascope_runner.urls'
...
WSGI_APPLICATION = 'privascope_runner.wsgi.application'
...
PORTAL_URL_BASE = 'http://portal:8000'
PORTAL_START = '/start'
